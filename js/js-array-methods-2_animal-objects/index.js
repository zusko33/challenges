...
console.log("first animal start with g: ", firstAnimalStartingWithLetterG);

const indexOfAnimalWithNameLongerFive = animals.findIndex(
  (animal) => animal.name.length > 5
);
console.log(
  "index of first animal name longer then 5: ",
...
console.log("animal sorted alpha: ", animalsSortedAlphabetically);

const animalsSortedByWeightStartingWithLowest = animals
  .slice()
  .sort((a, b) => a.weight - b.weight);
console.log(
  "animal sorted by weight:",
  animalsSortedByWeightStartingWithLowest
);

const animalsSortedByWeightReversed = animals.slice().reverse();

console.log("animal sorted reverse: ", animalsSortedByWeightReversed);

const animalWithWeightMoreThanFivehundredExists = animals.some(
  (animal) => animal.weight > 500
);
console.log(
  "is there animal with weight more then 500: ",
...
console.log(
  "are there animals in Europe weight less then 100: ",
...
console.log("all animals in Africa weight: ", weightOfAllAnimalsInAfrica);
...
console.log("average weight in africa", averageWeightOfAllAnimalsInAfrica);
export {
