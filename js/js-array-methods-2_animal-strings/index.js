...
console.log("is hippo there: ", hippoExists);

// Hint: You can pass the starting index as second parameter.
const catStartingFromIndexFiveExists = animalStrings.includes("tiger", 5);
console.log("is tiger from index 5: ", catStartingFromIndexFiveExists);

// Hint: Besides the array method, check out the string method `startsWith()`.
const firstAnimalStartingWithLetterP = animalStrings.find((animal) =>
  animal.startsWith("p")
);
console.log("first animal start with p: ", firstAnimalStartingWithLetterP);
...
console.log("animal end with z: ", anyAnimalEndsWithLetterZ);
const everyAnimalHasMoreThanTwoLetters = animalStrings.every(
  (animal) => animal.length > 2
);
console.log(
  "all animals have more then two letters: ",
